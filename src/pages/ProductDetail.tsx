            ...
            <div className="container mx-auto px-4 py-12">
                {isLoading ? (
                    ...
                    <>
                        ...
                        <nav className="mb-6 text-artisan-secondary">
                            <ol className="flex flex-wrap items-center">
                                <li>
                                    <Link href="/" className="hover:text-artisan-primary">
                                        Inicio
                                    </Link>
                                </li>
                                <li className="mx-2">/</li>
                                <li>
                                    <Link href="/products" className="hover:text-artisan-primary">
                                        Productos
                                    </Link>
                                </li>
                                <li className="mx-2">/</li>
                    ...
                    <div className="text-center py-12">
                        ...
                        <Link href="/products" className="artisan-button inline-block">
